...
public class AttestationApplicationId implements Comparable<AttestationApplicationId> {
    ...
    private AttestationApplicationId(DEROctetString attestationApplicationId) throws IOException {
        ASN1Sequence attestationApplicationIdSequence = (ASN1Sequence) ASN1Sequence
                .fromByteArray(attestationApplicationId.getOctets());
        ASN1Set attestationPackageInfos = (ASN1Set) attestationApplicationIdSequence
                .getObjectAt(Constants.ATTESTATION_APPLICATION_ID_PACKAGE_INFOS_INDEX);
        ...
        ASN1Set digests = (ASN1Set) attestationApplicationIdSequence
                .getObjectAt(Constants.ATTESTATION_APPLICATION_ID_SIGNATURE_DIGESTS_INDEX);
    ...
    static AttestationApplicationId createAttestationApplicationId(DEROctetString attestationApplicationId) {
    ...
    public boolean equals(Object o) {
        return (o instanceof AttestationApplicationId) && (compareTo((AttestationApplicationId) o) == 0);
    }
    ...
    public static class AttestationPackageInfo implements Comparable<AttestationPackageInfo> {
        ...
        private AttestationPackageInfo(ASN1Sequence packageInfo) {
            this.packageName = new String(
                    ((ASN1OctetString) packageInfo.getObjectAt(Constants.ATTESTATION_PACKAGE_INFO_PACKAGE_NAME_INDEX))
                            .getOctets(),
                    UTF_8);
            this.version = ((ASN1Integer) packageInfo.getObjectAt(Constants.ATTESTATION_PACKAGE_INFO_VERSION_INDEX)).getValue()
                    .longValue();
        }
