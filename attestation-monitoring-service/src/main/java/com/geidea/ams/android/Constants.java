...
public class Constants {
    ...
    public static final String GOOGLE_ROOT_CERTIFICATE1 = "-----BEGIN CERTIFICATE-----\n"
    ...
    public static final String GOOGLE_ROOT_CERTIFICATE2 = "-----BEGIN CERTIFICATE-----\n"
            ...
            + "-----END CERTIFICATE-----";
    public static final String GOOGLE_ROOT_CERTIFICATE3 = "-----BEGIN CERTIFICATE-----\n"
